...
<html lang="pt-br">
    ...
    //postagem 1
    $PostTit1 = "GAMES";
    $PostStit1 = "O mundo virtual está cada vez mais real";
    $PostData1 = "Março, 19, 2024";
    $PostTexto1 = "Cada vez mais as novas tecnologias estão a melhorar a capacidade dos games. Estão a se transformar em verdadeiras obras de artes. Muitas vezes fica dificil distinguir o real do virtual. Os úiltimos lançamentos da...";
    $PostComent1 = "0";
    //postagem 2
    $PostTit2 = "COLDZERA";
    $PostStit2 = "O melhor jogador que o Brasil ja teve, duas vezes campeão do mundo, juntamente com Fallen, porém duas vezes melhor do mundo, diferentemente de Fallen que foi apenas uma vez.";
    $PostData2 = "Março, 19, 2024";
    $PostTexto2 = "O Conter Strike no Brasil tem uma comunidade muito forte e unida, uma figura que foi muito responsável por este crescimento da comunidade no Brasil tem um nome, e este nome é Gaules. Dono do maior canal da Twitch do Brasil, e no mundo.";
    $PostComent2 = "2";
    ?>
<head>
    <meta charset="UTF-8">
    ...
    <div class="w3-row">
        ...
        <div class="w3-col w3-container" style="width: 65%;">
            ...
            <div class="w3-card-4 w3-margin w3-white">
                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ-2XbuHY2rlS1bi_cU3FWxBS1uHjTPhX4AX8ETTKKmohRTLLX9mvu1DUHm2A&s"
                    alt="Nature" style="width:100%;">
                <div class="w3-container w3-text-black">
                    <h3><b> 
                        <?php
                            $NPostagens+=1;
                            echo $NPostagens . "    " . $PostTit1;
                        ?>
                    </b>
                </h3>
                <h5><?php
                        echo $PostStit1 . ",<span class='w3-opacity'>" . $PostData1 . "</span>";
                    ?>
                </h5>
                </div>
                <div class="w3-container">
                    ...
                    <div class="w3-row" 
                        ...
                        <p><button class="w2-button w3-padding-large w3-white w3-border"><b>Leia Mais...</b></button>
                        </p>
                    </div>
            ...
            <div class="w3-card-4 w3-margin w3-white">
                <img src="data:image/jpeg;base64,"
                     style="width:100%;">
                <div class="w3-container w3-text-black">
                    <h3><b> <?php echo $NPostagens+=1 ?>-COLDZERA</b></h3>
                    <h5>O melhor jogador que o Brasil ja teve, duas vezes campeão do mundo, juntamente com Fallen, porém duas vezes melhor do mundo, diferentemente de Fallen que foi apenas uma vez.<span class="w3-opacity"> Março, 14, 2024</span></h5>
                </div>
                <div class="w3-container">
                    <p>O Conter Strike no Brasil tem uma comunidade muito forte e unida, uma figura que foi muito responsável por este crescimento da comunidade no Brasil tem um nome, e este nome é Gaules. Dono do maior canal da Twitch do Brasil, e no mundo.
                    </p>
                    <div class="w3-row" 
                        <div class="w3-col" style="width: 80%;">
                        <p><button class="w2-button w3-padding-large w3-white w3-border"><b>Leia Mais...</b></button>
                    ...
                    <div class="w3-col w3-hide-small" style="width: 20%;">
                        <p><span class="w3-padding-large w3-right"><b>Comments </b><span class="w3-tag"></span></span>
                        </p>
                    </div>
                </div>
            </div>
